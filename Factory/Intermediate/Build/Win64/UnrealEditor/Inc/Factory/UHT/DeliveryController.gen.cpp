...
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_ADeliveryController_Statics::NewProp_CurAttachedItem = { "CurAttachedItem", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ADeliveryController, CurAttachedItem), Z_Construct_UClass_AItem_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_CurAttachedItem_MetaData), NewProp_CurAttachedItem_MetaData) };
...
struct Z_CompiledInDeferFile_FID_JIHO_UE5_DT_SmartFactory_Factory_Source_Factory_AIController_DeliveryController_h__Script_Factory_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_ADeliveryController, ADeliveryController::StaticClass, TEXT("ADeliveryController"), &Z_Registration_Info_UClass_ADeliveryController, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ADeliveryController), 229838410U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_JIHO_UE5_DT_SmartFactory_Factory_Source_Factory_AIController_DeliveryController_h__Script_Factory_284382989(TEXT("/Script/Factory"),
